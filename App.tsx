                ...
                <div className="flex flex-wrap gap-2">
                    {['Intern', 'Junior', 'Mid-Level', 'Senior', 'Executive'].map(level => (
                        <button 
                            ...
                            className={`px-3 py-1.7 rounded-full text-xs font-medium border transition-colors ${selectedExpLevel === level ? 'bg-primary-600 text-white border-primary-600' : 'bg-white text-slate-600 border-slate-200 hover:border-primary-300'}`}
                        >
                            {level}
                        </button>
                    ))}
